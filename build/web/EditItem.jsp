            ...
            <div class="white-panel">
                <div class="login-show">
                    ...
                    <form id="addFood" method="POST" onsubmit="return checkAddFood(this)">
                        <input type="text" name="fname" class="form-control" placeholder="Enter Item Name" value="" />
                         <input type="text" name="flink" class="form-control" placeholder="Enter Item Link" value="" />
                        <input type="text" name="fprice" class="form-control" placeholder="Enter Price" value="" />
                ...
                <div class="register-show">
                    ...
                    <form id="addMed" method="POST"  onsubmit="return checkAddMedicalSupplies(this)">
                        ...
                        <input type="text" name="mname" class="form-control" placeholder="Enter Item Name" value="" />
                         <input type="text" name="mlink" class="form-control" placeholder="Enter Item Link" value="" />
                        <input type="text" name="mprice" class="form-control" placeholder="Enter Price" value="" />
